...
def organize_emails():
    ...
    # Replace 'trial' with the actual label name
    destination_folder = 'Label_3789045279193646982'

    # Example: Move emails from 'recruitment.entrylevel@tcs.com' to the 'Example' folder
    sender_email = 'recruitment.entrylevel@tcs.com'
